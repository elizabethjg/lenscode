...
def NFW_stack_fit(R,D_Sigma,err,c,roc):
	# R en Mpc, D_Sigma M_Sun/pc2
	#Ecuacion 15 (g(x)/2)
	...
	return R200,e_R200,chired,xplot,yplot
...
def NFW_fit_c(R,shear,err,zlens,sigmac):
	#Ecuacion 15 (g(x)/2)
...
def NFW_fit(R,shear,err,c,zlens,sigmac):
	#Ecuacion 15 (g(x)/2)
